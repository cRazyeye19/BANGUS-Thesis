  ...
  return (
    <Link
      ...
      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
        isActive ? "text-bangus-teal bg-teal-50 font-medium" : "text-gray-600 hover:bg-gray-50 hover:text-bangus-teal"
      }`}
    >
      <FontAwesomeIcon icon={icon} className={`w-4 h-4 ${isActive ? "text-bangus-teal" : "text-gray-500"}`} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <img src={Logo || "/placeholder.svg"} alt="Bangus Logo" className="w-8 h-8 object-contain" />
              <a href="/" className="ml-2 text-xl font-bold text-bangus-teal hover:text-bangus-cyan transition-colors">
                BANGUS
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex gap-2 py-2 overflow-x-auto scrollbar-hide">
            ...
            <NavItem
              ...
              currentPath={location.pathname}
            />
            <NavItem to="/settings" icon={faGears} text="Settings" currentPath={location.pathname} />
            {/* <NavItem to="/about-us" icon={faPeopleGroup} text="About Us" currentPath={location.pathname} />s */}
          </div>
        </div>
      </nav>
    </>
